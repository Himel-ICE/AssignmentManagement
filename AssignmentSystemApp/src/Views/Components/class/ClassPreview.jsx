...
export default function ClassPreview({ form }) {

    const { name, department, semester, section, description, isActive } = form;
    ...
    return (
        <div className="lg:sticky lg:top-0">
            ...
            <div className="rounded-2xl border border-cyan-200 bg-white p-4 shadow-sm">
                ...
                <div className="mt-2 flex items-center justify-between rounded-lg border border-cyan-100 bg-cyan-50/50 px-3 py-2 text-sm">
